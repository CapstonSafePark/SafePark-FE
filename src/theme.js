...
export const getStyles = (t) => ({
  ...
  frame: { width: "100%", maxWidth: "480px", height: "100vh", background: t.frame, padding: "16px", paddingBottom: "80px", color: t.textPrimary, fontFamily: "Noto Sans KR", position: "relative", overflowY: "auto" },
