...
export const getStyles = (t) => ({
  ...
  smallBtn: { marginTop: "8px", padding: "10px", width: "100%", borderRadius: "8px", border: "none", background: t.smallBtnBg, color: t.textPrimary, cursor: "pointer", fontSize: 13, transition: "opacity 0.15s", fontWeight: "600" },
