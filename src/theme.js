...
export const getStyles = (t) => ({
  ...
  detailBtn: { flex: 1, padding: "8px", borderRadius: "8px", border: `1px solid ${t.accent}`, background: "rgba(79,142,247,0.12)", color: t.accent, cursor: "pointer", fontSize: 13, transition: "background 0.15s, color 0.15s", fontWeight: "600" },
  deleteBtn: { flex: 1, padding: "8px", borderRadius: "8px", border: `1px solid ${t.danger}`, background: "rgba(231,77,60,0.12)", color: t.danger, cursor: "pointer", fontSize: 13, transition: "background 0.15s, color 0.15s", fontWeight: "600" },
