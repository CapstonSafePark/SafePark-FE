...
export const getStyles = (t) => ({
  ...
  frame: { width: "100%", maxWidth: "480px", height: "100vh", background: t.frame, padding: "16px", paddingBottom: "100px", color: t.textPrimary, fontFamily: "Noto Sans KR", position: "relative", overflowY: "auto", boxSizing: "border-box" },
  ...
  uploadBox: { flex: 1, background: `rgba(79,142,247,0.06)`, border: `1px solid rgba(79,142,247,0.3)`, borderRadius: "12px", padding: "12px", textAlign: "center", fontSize: "12px", cursor: "pointer", color: t.accent, fontWeight: "600" },
  ...
  subCard: { marginTop: "10px", padding: "10px", background: t.cardSub, borderRadius: "8px", fontSize: "11px", color: t.textSecondary, border: `1px solid ${t.border}`, fontWeight: "600" },
  ...
  label: { fontSize: "11px", color: t.textSecondary, marginBottom: 2, fontWeight: "600" },
  ...
  detailBtn: { flex: 1, padding: "8px", borderRadius: "8px", border: `1px solid ${t.accent}`, background: "transparent", color: t.accent, cursor: "pointer", fontSize: 13, transition: "background 0.15s, color 0.15s", fontWeight: "600" },
  deleteBtn: { flex: 1, padding: "8px", borderRadius: "8px", border: `1px solid ${t.danger}`, background: "transparent", color: t.danger, cursor: "pointer", fontSize: 13, transition: "background 0.15s, color 0.15s", fontWeight: "600" },
  ...
  withdrawBtn: { marginTop: "8px", padding: "10px", width: "100%", borderRadius: "8px", border: `1px solid rgba(231,77,60,0.4)`, background: "transparent", color: t.danger, cursor: "pointer", fontSize: 13, transition: "background 0.15s, color 0.15s", fontWeight: "600" },  infoRow: { display: "flex", justifyContent: "space-between", alignItems: "center", padding: "8px 0", borderBottom: `1px solid ${t.border}` },
